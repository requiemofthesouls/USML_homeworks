...
def start_consume(callback, queue):
    try:
        ...
        syslog.syslog("Error while consuming %s %s" % (queue, exc))
...
if __name__ == "__main__":
    ...
    try:
        thr_list = [
            start_consume(callback_one, 'queue_one'),
            start_consume(callback_two, 'queue_two'),
            start_consume(callback_three, 'queue_three'),
            start_consume(callback_mail, 'queue_mail'),
            start_consume(callback_sms, 'queue_sms'),
            start_consume(callback_telegram, 'queue_telegram')
        ]
